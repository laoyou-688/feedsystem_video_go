...
type FeedConfig struct {
	FollowingFanoutThreshold int `yaml:"following_fanout_threshold"`
	ActiveFollowerWindowHours int `yaml:"active_follower_window_hours"`
	FollowingPullCacheTTLSeconds int `yaml:"following_pull_cache_ttl_seconds"`
}
...
func DefaultLocalConfig() Config {
	return Config{
		...
		Feed: FeedConfig{
			FollowingFanoutThreshold: 2000,
			ActiveFollowerWindowHours: 72,
			FollowingPullCacheTTLSeconds: 30,
		},
